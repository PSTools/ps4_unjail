...
#define KERN_75X_XFAST_SYSCALL      0x1C0		// #1
...
#define KERN_75X_PRISON_0       0x0113B728
...
#define KERN_75X_ROOTVNODE      0x01B463E0
...
void  *unjail75X(struct thread *td){
	...
	void* kernel_base = &((uint8_t*)__readmsr(0xC0000082))[-KERN_75X_XFAST_SYSCALL];
	uint8_t* kernel_ptr = (uint8_t*)kernel_base;
	void** got_prison0 = (void**)&kernel_ptr[KERN_75X_PRISON_0];
	void** got_rootvnode = (void**)&kernel_ptr[KERN_75X_ROOTVNODE];
